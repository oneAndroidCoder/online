...
public class HomeActivity extends BasicActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void init() {
        ...
        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab_enter_personal);
